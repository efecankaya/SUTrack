<table class="table">
    ...
    <tbody>
        ...
        $sql_statement = "SELECT med_id, med_name, med_rating, med_release FROM Users NATURAL JOIN Favorite NATURAL JOIN Media WHERE usr_id = $userid";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            echo '  <td>
                    ...
                    '" onclick="ToggleF(document.getElementById(\'fav' . $id . '-1\'))" id="fav' . $id . '-1" class="btn"><i class="fa-solid fa-heart"></i></button>
                    </form>
                    <iframe name="i" style="display:none;"></iframe>
                    ...
                    '" onclick="ToggleW(document.getElementById(\'wat' . $id . '-1\'))" id="wat' . $id . '-1" class="btn"><i class="fa-solid fa-eye"></i></button>
                    </form>
                    </td>
                </tr>
            ';
