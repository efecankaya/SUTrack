<table class="table">
    ...
    <tbody>
        ...
        $sql_statement = "SELECT * FROM Person NATURAL JOIN Directs NATURAL JOIN Media";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            echo '  <td>
                    <form style="display:inline-block; margin:0;" action="delete_directs.php" method="POST">
